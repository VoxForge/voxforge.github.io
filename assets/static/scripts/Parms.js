...
function Parms() {
    ...
    if ( ! (window.location.origin === 'https://voxforge.github.io') ) { 
        ...
        this.controller.numPrompt2SubmittForRecordInfo = 5;
        this.uploader.maxMinutesSinceLastSubmission = 30; // only relevant if recording information is included with submission
    } 
